//1.	Написать функцию Rectangle, которая выводит на экран прямоугольник.Функция принимает такие параметры : ширина, высота, символ рамки, символ заливки, цвет рамки, цвет заливки.
#include <iostream>
#include <Windows.h>
using namespace std;
